...
class DetailWahana extends StatefulWidget {
  ...
  const DetailWahana({super.key, required this.wahana});
                      ...
                      children: [
                        PageView(
                          ...
                          children: List.generate(
                            widget.wahana.image!.length,
                            (index) => Image.network(
                              fit: BoxFit.cover,
                              widget.wahana.image![index],
                            ),
                          ),
                        ),
                        Column(
                      ...
                      children: [
                        ...
                        Text.rich(
                          TextSpan(
                            children: [
                              TextSpan(
                                text: 'Rp.${widget.wahana.price}.000',
                                style: TextStyle(
                                  fontSize: 19,
