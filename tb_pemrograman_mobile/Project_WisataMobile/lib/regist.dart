...
class _MyHomePageState extends State<MyHomePage> {
  bool _isChecked = false; // Track whether the checkbox is selected
          ...
          children: <Widget>[
            ...
            ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                ...
                backgroundColor:
                    Colors.black, // Changed background color to blue (#0000FF)
                          ...
                          decoration: ShapeDecoration(
                            shape: RoundedRectangleBorder(
                              side: BorderSide(
                                width: 1,
                                color:
                                    Colors.white, // Change line color to white
                              ...
                              child: Row(
                                ...
                                children: [
                                  Icon(
                                    ...
                                    size: 30,
                                    color: Colors.blue, // Google icon color
                                  ),
                                  SizedBox(width: 8),
                                  Text(
                                    'Google',
              ...
              children: [
                ...
                TextButton(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(
                      fontSize: 14,
                      color: Colors.white, // Changed color to blue (#0000FF)
                      fontFamily: 'Poppins',
                      fontWeight: FontWeight.w300,
                    ),
                  ),
